    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-gray-600">
          We had love to hear from you! Please feel free to reach to our developer Sourabh Singh Bais and we all get in touch with you as soon as possible.
          His Portfolio is available  -- <Link className="text-blue-900 hover:text-blue-600" href="https://sourabh-singh-bais-portfolio.vercel.app/" >click here</Link> 
        </p>
      </div>
